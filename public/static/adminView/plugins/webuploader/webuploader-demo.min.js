jQuery(function() {
        ...
        if (e !== k) {
            switch (c.removeClass("state-" + k), c.addClass("state-" + e), k = e) {
                ...
                case "confirm":
                    ...
                    break;
                case "finish":
                    a = n.getStats(), a.successNum ? layer.msg('上传成功',{icon:1,time:1000}) : (k = "done", location.reload())
            }
            i()
        }
    }
    ...
    n.on('uploadSuccess',function(file,res){
        $('#uploader').append('<input type="hidden" id="img_pic" class="hiddenInput" value="' + res.mes + '" />')
