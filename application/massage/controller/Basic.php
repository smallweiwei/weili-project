...
class Basic extends Controller
{
    ...
    public function initialize()
    {
        ...
        if(strstr($_SERVER['HTTP_USER_AGENT'],'MicroMessenger')){
            ...
            if(empty($list)){
                ...
                $id = Db::name('users')
                    ->insertGetId($data);
                Cookie::set('u_nickname',preg_replace('/[\x{10000}-\x{10FFFF}]/u', '',$wxuser['nickname']));
                Cookie::set('u_user_id',$id);
            }else{
                Cookie::set('u_nickname',$list['u_nickname']);
    ...
    private function GetOpenid(){
        ...
        if(!isset($_GET['code'])){
            ...
            $userInfo = $this->GetUserinfo(Session::get('access_token'),Session::get('openid'));
            return $userInfo;
        }
    }
