...
return [
    ...
    'official_account' => [
        'default' => [
            // AppID
            'app_id' => env('WECHAT_OFFICIAL_ACCOUNT_APPID', 'wxc7d11a087b99ecdf'),
            // AppSecret
            'secret' => env('WECHAT_OFFICIAL_ACCOUNT_SECRET', 'ad935003349978f8d1c4fa7746d28407'),
            // Token
            'token' => env('WECHAT_OFFICIAL_ACCOUNT_TOKEN', 'mYyPYPwBR38G5p88'),
            // EncodingAESKey
