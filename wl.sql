...
--
-- Host: localhost:3306
-- Generation Time: 2019-05-22 08:04:02
...
(2, '管理员', '拥有部分权限', 1, '1,2', '2019-05-21 02:26:17', 1),
(3, '乐婴岛门店', '全部门店所属角色', 1, '11,12', '2019-05-20 03:26:10', 1),
(4, '门店小儿推拿', '门店小儿推拿角色', 1, '13,15,14,16,17,18', '2019-05-20 09:29:01', 1),
(5, '荔骏会', '', 1, '1,2,3,4', '2019-05-20 05:43:10', 1);
...
(5, 'admin5', '$2y$10$xIONNGE2jWEvtlpGTspC8.FA.8W3mcZ1T5Rol.hBYeMbaO1aiv5oO', 1, '2019-05-20 03:18:30', 1, 1),
(6, 'admin6', '$2y$10$xIONNGE2jWEvtlpGTspC8.FA.8W3mcZ1T5Rol.hBYeMbaO1aiv5oO', 0, '2019-05-20 03:18:30', 1, 1),
(7, 'admin7', '$2y$10$xIONNGE2jWEvtlpGTspC8.FA.8W3mcZ1T5Rol.hBYeMbaO1aiv5oO', 2, '2019-05-20 03:18:30', 1, 1),
(8, 'admin8', '$2y$10$xIONNGE2jWEvtlpGTspC8.FA.8W3mcZ1T5Rol.hBYeMbaO1aiv5oO', 0, '2019-05-20 03:18:30', 1, 1),
...
(11, 'admin', '$2y$10$1GaSULRb.ql0liqiJ875teHUaQVPFNl2l0w9hM5Bv0e4bG30eBlay', 0, '2019-05-20 04:18:38', 2, 1),
(12, 'admin1', '$2y$10$TrDJ0MUR42ZS4.hfkx9Y8.3c6XYkd9S9FlszNjVSdV0zvBUlAU7Iq', 0, '2019-05-20 04:18:41', 2, 1);
...
--
-- 表的结构 `wl_massage_personnel_access`
--
...
--
-- 转存表中的数据 `wl_massage_personnel_access`
--

INSERT INTO `wl_massage_personnel_access` (`mp_id`, `group_id`) VALUES
(1, 4),
(2, 4),
(3, 4),
(4, 4),
...
INSERT INTO `wl_store` (`s_id`, `s_name`, `s_phone`, `s_pic`, `s_address`, `s_time`, `s_delete`) VALUES
(1, '金沙店乐婴岛', '18927543087', './static/uploads/store/20190306\\f415ff7ce750cb5c01175db33222ec90.png', '广东省广州市海珠区金沙路16至20号首层商铺自编之十二', '2019-03-06 02:34:43', 1),
(2, '万达店乐婴岛', '17728026810', './static/uploads/store/20190306\\312193fdfcf570fa778aff40bae550ac.jpg', '桂城街道桂澜北路28号南海万达广场南7栋235号铺', '2019-03-06 02:37:28', 1),
(3, '测试', '', './static/uploads/store/20190521/2c246beb6edbbc74b9f133708b5ea6e4.jpeg', '测试', '2019-05-21 10:28:08', -1),
(4, '测试0', '', '', '测试', '2019-05-21 15:47:11', -1),
(5, '测试1', '', '', '测试', '2019-05-21 22:55:28', -1),
(6, '测试2', '', '', '测试2', '2019-05-21 22:56:40', -1),
(7, '123去玩儿', '', '', '123', '2019-05-22 00:02:54', -1);
...
--
-- 表的结构 `wl_store_personnel_access`
--
...
--
-- Indexes for table `wl_massage_personnel_access`
--
ALTER TABLE `wl_massage_personnel_access`
  ADD UNIQUE KEY `uid_group_id` (`mp_id`,`group_id`) USING BTREE,
  ADD KEY `mp_id` (`mp_id`) USING BTREE,
  ADD KEY `group_id` (`group_id`) USING BTREE;
...
ALTER TABLE `wl_store`
  ...
  ADD UNIQUE KEY `store_id` (`s_id`) USING BTREE;

--
-- Indexes for table `wl_store_personnel_access`
--
ALTER TABLE `wl_store_personnel_access`
  ADD UNIQUE KEY `uid_group_id` (`sp_id`,`group_id`) USING BTREE,
...
--
ALTER TABLE `wl_auth_group`
  MODIFY `ag_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `wl_manager`
  MODIFY `m_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '管理员id', AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `wl_store`
  MODIFY `s_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '门店id', AUTO_INCREMENT=8;
--
